 ...
 * @Last Modified by: 1k
 * @Last Modified time: 2020-03-12 11:40:01
 * @Description:  功能管理
 */
<template>
    ...
    <el-dialog :title="dialogTitle[operateStatus]"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="路由参数"
                      prop="params">
          <el-input v-model="treeform.params"
                    :clearable="clearable"
                    style="width:155px"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    updateOption(row) {
      ...
      this.treeform.params = row.params
      this.$nextTick(function() {
        this.$refs.form.clearValidate()
      })
    },
    ...
    handleDrop(draggingNode, dropNode, dropType, ev) {
      ...
      baseRequest('/basic/function/orderTree', params).then(_ => {
        this.searchOption()
        this.getTree()
      })
    },
