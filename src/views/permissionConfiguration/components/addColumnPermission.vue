...
const url = '/basic/columnPermission/getColumnByPermission'
export default {
  directives: {},
  name: 'permissionConfigurationComponentsAddColumnPermission',
  components: {
    SearchForm,
    BasicTable
  },
  ...
  methods: {
    ...
    saveOperate() {
      ...
      baseRequest('/basic/columnPermission/addColumn', param).then(request => {
